...
public class ItemCodeOnCreate extends RecipeCodeHelper {
    ...
    public static void onCreateOldPhoto(InventoryItem item) {
        onCreatePhoto(item, "OldPhoto", Rand.Next(ItemGenerationConstants.OLD_PHOTOS).getTranslationKey());
    }
    ...
    public static void onCreatePostcard(InventoryItem item) {
        onCreatePhoto(item, "Postcard", Rand.Next(Registries.DOODLE_KIDS.values()).getTranslationKey());
    }
    ...
    public static void onCreateCookwareSchematic(Literature item) {
        setSchematicLearnedRecipes(item, ItemGenerationConstants.MELEE_WEAPON_SCHEMATICS, 40);
    }
