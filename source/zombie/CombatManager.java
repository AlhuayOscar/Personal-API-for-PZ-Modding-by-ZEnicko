                    ...
                    if (hitVehicle == null && hitObject.getSquare() != null && owner.getSquare() != null) {
                        ...
                        if (hitObject instanceof IsoGameCharacter character) {
                            ...
                            GameClient.sendPlayerHit(
                                owner, hitObject, weapon, hitDamage, ignoreHitCountDamage, rangeDel, isCriticalHit, helmetFall, hitHead > 0, removeKnife
                            );
                        }
                        ...
                        if (hitVehicle.processHit(owner, weapon, damageSplit)) {
                            ...
                            GameClient.sendPlayerHit(
                                owner, hitVehicle, weapon, damageSplit, ignoreHitCountDamage, rangeDel, isCriticalHit, helmetFall, hitHead > 0, removeKnife
                            );
                        }
                        break;
                    }
