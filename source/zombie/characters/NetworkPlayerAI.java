...
public class NetworkPlayerAI extends NetworkCharacterAI {
    ...
    private void setMoving(Prediction prediction) {
        ...
        if (PolygonalMap2.instance
            .lineClearCollide(this.player.getX(), this.player.getY(), this.tempo.x, this.tempo.y, PZMath.fastfloor(this.player.getZ()), null, false, true)) {
        ...
        if (this.player instanceof IsoAnimal animal) {
            ...
            if (receiver != null) {
                ...
                boolean detailedInfoDistCheck = playerReceiver != null
                    && IsoUtils.DistanceManhatten(playerReceiver.getX(), playerReceiver.getY(), animal.getX(), animal.getY()) <= 4.0F;
        ...
        if (this.player instanceof IsoAnimal animal) {
            ...
            if (packet.location != 1 && hutch != null) {
                IsoGridSquare animalSq = IsoWorld.instance
                    .currentCell
                    .getGridSquare(hutch.savedX + hutch.getEnterSpotX(), hutch.savedY + hutch.getEnterSpotY(), hutch.savedZ);
