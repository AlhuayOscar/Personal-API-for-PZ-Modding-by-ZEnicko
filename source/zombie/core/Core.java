...
public final class Core {
    ...
    private static final GameVersion gameVersion = new GameVersion(42, 15, "");
    ...
    public String getGitSha() {
        if (this.gitSha == null) {
            this.gitSha = IS_DEV ? DevMainScreenState.getDevSha() : "7bbae0e8a3a4468f4bb195a51654ae115e9568c7";
        }
    ...
    public String getGitRevision() {
        if (this.gitRevisionString == null) {
            if (IS_DEV) {
                ...
                this.gitRevisionString = "7bbae0e8a3a4468f4bb195a51654ae115e9568c7"
                    .substring(0, Math.min("7bbae0e8a3a4468f4bb195a51654ae115e9568c7".length(), 20));
            }
        }
    ...
    public static String getGitRevisionString() {
        return IS_DEV ? core.getGitRevision() : "7bbae0e8a3a4468f4bb195a51654ae115e9568c7 2026-03-09 13:26:38 (ZB)";
    }
