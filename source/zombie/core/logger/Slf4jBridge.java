    ...
    public ILoggerFactory getLoggerFactory() {
        return name -> new LegacyAbstractLogger() {
            ...
            protected void handleNormalizedLoggingCall(Level level, Marker marker, String msg, Object[] args, Throwable t) {
                ...
                if (t == null) {
                    DebugLog.General.routedWrite(3, Slf4jBridge.LOG_SEVERITY_BY_LEVEL.get(level), msg.formatted(args));
                } else {
                    DebugLog.General.printException(t, Slf4jBridge.LOG_SEVERITY_BY_LEVEL.get(level), msg, args);
                }
            }
