    ...
    public static Texture getSharedTexture(String name, int flags) {
        if (GameServer.server && !ServerGUI.isCreated()) {
            ...
            try {
                ...
                DebugType.FileIO.printException(var3, "Failed to load shared texture: " + name, LogSeverity.Error);
                return null;
            }
        }
    }
    ...
    public static Texture getTexture(String name) {
        ...
        if (BucketManager.Active().HasTexture(name)) {
            ...
            try {
                ...
                DebugType.FileIO.printException(var3, "Failed to load texture: " + name, LogSeverity.Error);
                return null;
            }
        }
    }
