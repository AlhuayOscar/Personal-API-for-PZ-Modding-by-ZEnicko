...
public final class JoypadManager {
    ...
    public float getMovementAxisX(int joypadIndex) {
        ...
        return joypad != null && joypad.isMovementAxisBeingApplied() ? joypad.getMovementAxisX() : 0.0F;
    }

    public float getMovementAxisY(int joypadIndex) {
        JoypadManager.Joypad joypad = this.checkJoypad(joypadIndex);
        return joypad != null && joypad.isMovementAxisBeingApplied() ? joypad.getMovementAxisY() : 0.0F;
    }
    ...
    public float getAimingAxisX(int joypadIndex) {
        JoypadManager.Joypad joypad = this.checkJoypad(joypadIndex);
        return joypad != null && joypad.isAimingAxisBeingApplied() ? joypad.getAimingAxisX() : 0.0F;
    }

    public float getAimingAxisY(int joypadIndex) {
        JoypadManager.Joypad joypad = this.checkJoypad(joypadIndex);
        return joypad != null && joypad.isAimingAxisBeingApplied() ? joypad.getAimingAxisY() : 0.0F;
    }
