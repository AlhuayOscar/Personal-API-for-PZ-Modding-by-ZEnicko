...
public class AddXpPacket implements INetworkPacket, AntiCheatXP.IAntiCheat, AntiCheatXPPlayer.IAntiCheat {
    ...
    public void setData(Object... values) {
        if (values.length == 3) {
            ...
            this.set((IsoPlayer)values[0], (PerkFactory.Perk)values[1], (Float)values[2], (Boolean)values[3], (Boolean)values[4]);
        } else {
    ...
    public void processServer(PacketTypes.PacketType packetType, UdpConnection connection) {
        addXp(connection, this.target.getPlayer(), this.perk.getPerk(), this.amount, this.noMultiplier, this.showXP);
    }
    ...
    public static void addXp(UdpConnection connection, IsoPlayer player, PerkFactory.Perk perk, float amount, boolean noMultiplier, boolean showXP) {
        if (!GameServer.canModifyPlayerStats(connection, player)) {
            ...
            INetworkPacket.send(player, PacketTypes.PacketType.AddXP, player, perk, amount, noMultiplier, showXP);
        }
    }
}
