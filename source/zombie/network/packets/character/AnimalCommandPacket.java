    ...
    public void parse(ByteBufferReader b, IConnection connection) {
        ...
        if (AnimalCommandPacket.Type.UpdateGenome == this.type) {
            ...
            try {
                ...
                DebugLog.Multiplayer.printException(var7, "Animal genome read failed", LogSeverity.Error);
                return;
            }
        } else {
            ...
            if (itemID != -1) {
                try {
                    ...
                    DebugLog.Multiplayer.printException(var6, "AnimalInventoryItem load failed", LogSeverity.Error);
                }
            }
        }
    }
