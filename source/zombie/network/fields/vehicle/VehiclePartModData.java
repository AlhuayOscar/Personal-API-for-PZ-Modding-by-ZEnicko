...
public class VehiclePartModData extends VehicleField implements INetworkPacketField {
    ...
    public void parse(ByteBufferReader bb, IConnection connection) {
        try {
            ...
            DebugLog.Multiplayer.printException(var14, LogSeverity.Error, "%s: failed", this.getClass().getSimpleName());
        }
    }
    ...
    public void write(ByteBufferWriter b) {
        try {
            ...
            DebugLog.Multiplayer.printException(var12, this.getClass().getSimpleName() + ": failed", LogSeverity.Error);
        }
    }
}
