                ...
                if (player != null && !player.isDead() && player.isAiming()) {
                    if (!GameTime.isGamePaused()) {
                        if (this.isoReticleShader != null && this.isoReticleShader.isCompiled()) {
                            ...
                            this.isoReticleShader.screenX = (int)(AimingReticle.getXA(playerIndex) - width / 2.0F);
                            this.isoReticleShader.screenY = (int)(AimingReticle.getYA(playerIndex) - height / 2.0F);
