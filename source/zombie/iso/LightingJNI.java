...
public final class LightingJNI {
    ...
    public static float calculateVisionConeOld(IsoGameCharacter player) {
        ...
        if (player.getVehicle() == null) {
            ...
            DebugType.Lightning.debugln("cone 1 %f", cone);
            cone *= player.getWornItemsVisionModifier();
            DebugType.Lightning.debugln("cone 2 %f", cone);
            if (cone > 0.0F) {
                cone = 0.0F;
            } else if (cone < -0.9F) {
                cone = -0.9F;
            ...
            DebugType.Lightning.debugln("cone 3 %f", cone);
        } else {
                    ...
                    if (player != null) {
                        ...
                        if ((this.vis & 2) == 0 && (this.vis & 4) != 0) {
                            ...
                            if (player.dir != null && Math.abs(dx) <= 2 && Math.abs(dy) <= 2) {
                                int[] fv = LightingJNI.ForcedVis[player.dir.ordinal()];
